...
// Logos for the printed report header (left = COMFED, right = SUDHA).
// Paste a base64 data URI between the quotes once the logo images are provided;
// until then a clean text fallback is shown so nothing breaks.
const COMFED_LOGO = '';
const SUDHA_LOGO = '';
